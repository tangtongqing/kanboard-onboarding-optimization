...
| 上游依据 | `docs/02-requirements/用户故事与验收标准-PD-004.md`、`docs/02-requirements/功能优化PRD骨架-PD-003.md`、`docs/04-implementation-log/00-foundation/新手创建向导说明-V0.5.md` |

> **声明**：本文档是基于 PD-004 用户故事的流程图与信息架构，不是基于真实用户研究的最终版本。标注 `[待验证]` 的内容需要在 PD-002 研究执行后更新。

## 1. 文档目的

1. 将 PD-004 中的用户故事转成正式流程图、信息架构和页面/状态清单。
...
本图把 PD-004 的用户故事按用户行为层、P0 首次可用范围、P1 增强范围和 P2 后续范围组织，作为后续流程图与交互状态规格的总览。
