...
> 状态：进行中 | 启动日期：2026-05-31 | 当前版本：V0.8.10 弹窗关闭逻辑修复
...
| `tests/static-feature-audit-v08.js` | Playwright 静态功能验收脚本，覆盖 104 个核心检查项 |
...
![Kanboard 弹窗关闭逻辑修复 V0.8.10](设计图/kanboard-v0.8.10-dialog-close-fix.png)
