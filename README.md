...
> 状态：进行中 | 启动日期：2026-05-31 | 当前版本：V0.8.20 运维任务与后台执行补齐
...
| `tests/static-feature-audit-v08.js` | Playwright 静态功能验收脚本，覆盖 201 个核心检查项 |
...
| V0.8.21 | 数据库配置、性能优化、附件存储路径、升级流程继续补齐 | 下一步 |
...
- 数据库配置、SQLite/MySQL/PostgreSQL 和性能优化。
- 附件存储路径、升级流程和安装环境检查。
...
![Kanboard 运维任务 V0.8.20](设计图/kanboard-v0.8.20-operations-run-log.png)
