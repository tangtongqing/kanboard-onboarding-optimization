...
> 状态：进行中 | 启动日期：2026-05-31 | 当前版本：V0.8.6 固定侧栏与右侧滚动修复
...
| `tests/static-feature-audit-v08.js` | Playwright 静态功能验收脚本，覆盖 87 个核心检查项 |
...
![Kanboard 固定侧栏与右侧滚动 V0.8.6](设计图/kanboard-v0.8.6-fixed-sidebar-scroll.png)
