...
> 状态：进行中 | 启动日期：2026-05-31 | 当前版本：V0.8.9 列显示面板优化
...
| `tests/static-feature-audit-v08.js` | Playwright 静态功能验收脚本，覆盖 100 个核心检查项 |
...
![Kanboard 列显示面板优化 V0.8.9](设计图/kanboard-v0.8.9-column-picker.png)
