...
> 状态：进行中 | 启动日期：2026-05-31 | 当前版本：V0.8.4 多项目示例补齐
...
| `tests/static-feature-audit-v08.js` | Playwright 静态功能验收脚本，覆盖 80 个核心检查项 |
...
![Kanboard 多项目示例 V0.8.4](设计图/kanboard-v0.8.4-multi-project-demo.png)
