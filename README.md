...
> 状态：进行中 | 启动日期：2026-05-31 | 当前版本：V0.8.11 泳道建模逻辑修正
...
| `tests/static-feature-audit-v08.js` | Playwright 静态功能验收脚本，覆盖 105 个核心检查项 |
...
![Kanboard 泳道建模逻辑修正 V0.8.11](设计图/kanboard-v0.8.11-swimlane-model-fix.png)
