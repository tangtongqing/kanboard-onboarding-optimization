...
> 状态：进行中 | 启动日期：2026-05-31 | 当前版本：V0.8.7 泳道空列精简与流程状态升级
...
| `tests/static-feature-audit-v08.js` | Playwright 静态功能验收脚本，覆盖 89 个核心检查项 |
...
![Kanboard 泳道空列精简 V0.8.7](设计图/kanboard-v0.8.7-lane-compact-workflow.png)
