...
> 状态：进行中 | 启动日期：2026-05-31 | 当前版本：V0.8.17 插件管理补齐
...
| `tests/static-feature-audit-v08.js` | Playwright 静态功能验收脚本，覆盖 162 个核心检查项 |
...
| V0.8.18 | 全局用户/组管理、外部认证或管理员 CLI 能力继续补齐 | 下一步 |
...
![Kanboard 插件管理 V0.8.17](设计图/kanboard-v0.8.17-plugin-installer-enabled.png)
