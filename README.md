...
> 状态：进行中 | 启动日期：2026-05-31 | 当前版本：V0.3 Kanboard MVP 复现
...
| V0.4 | 新手创建向导优化：模板、示例卡、创建前预览 | 未开始 |
| V0.5 | PRD草稿、埋点、验收标准 | 未开始 |
| V1.0 | 作品集版文档与原型说明 | 未开始 |

## 下一步

进入 V0.4 新手创建向导优化：
- 在“新建项目”入口增加“空白项目 / 从模板开始”。
- 定义 4 个模板的列结构和示例卡片。
- 支持创建前预览模板内容。
...
![Kanboard MVP V0.3](设计图/kanboard-mvp-v0.3.png)
