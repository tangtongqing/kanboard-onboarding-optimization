...
> 状态：进行中 | 启动日期：2026-05-31 | 当前版本：V0.8.8 项目周期时间系统
...
| `tests/static-feature-audit-v08.js` | Playwright 静态功能验收脚本，覆盖 97 个核心检查项 |
...
![Kanboard 项目周期时间系统 V0.8.8](设计图/kanboard-v0.8.8-project-cycle-system.png)
