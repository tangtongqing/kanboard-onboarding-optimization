...
> 状态：进行中 | 启动日期：2026-05-31 | 当前版本：V0.8.18 全局用户与用户组管理补齐
...
| `tests/static-feature-audit-v08.js` | Playwright 静态功能验收脚本，覆盖 175 个核心检查项 |
...
| V0.8.19 | 外部认证、管理员 CLI、后台任务或系统配置继续补齐 | 下一步 |
...
![Kanboard 用户组管理 V0.8.18](设计图/kanboard-v0.8.18-group-membership.png)
