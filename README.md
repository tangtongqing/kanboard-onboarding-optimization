...
- [x] PD-019B 首次核心操作轻引导项目内高保真图稿归档与 Figma-ready 导入包（12 张 SVG/PNG、manifest、contact sheet；线上 Figma node 未追加）
