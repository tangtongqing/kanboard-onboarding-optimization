...
> 状态：进行中 | 启动日期：2026-05-31 | 当前版本：V0.8.19 系统认证与安全配置补齐
...
| `tests/static-feature-audit-v08.js` | Playwright 静态功能验收脚本，覆盖 188 个核心检查项 |
...
| V0.8.20 | 管理员 CLI、Cronjob、后台任务、邮件或数据库性能配置继续补齐 | 下一步 |
...
![Kanboard 系统认证配置 V0.8.19](设计图/kanboard-v0.8.19-config-preview.png)
